package com.saucy.framework.rendering;
...
public class Graphic implements Renderable {
	...
	public Graphic(Vector2 center, Vector2 size, Texture texture) {
		this(center, size, new TextureRegion(texture));
	}
	
	public Graphic(Vector2 center, TextureRegion texture) {
		this(center.x, center.y, texture.getRegionWidth(), texture.getRegionHeight(), new TextureRegion(texture));
	}
	public Graphic(Vector2 center, Texture texture) {
		this(center, new TextureRegion(texture));
	}
	...
	public void setTexture(Texture newTexture) {
		texture = new TextureRegion(newTexture);
	}
	/**
	 * Set the graphic's texture to newTexture.
	 */
