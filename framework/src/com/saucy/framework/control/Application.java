...
import com.saucy.framework.rendering.Screen;
...
//		// Initialize our orthographic camera with the screen's actual size.
		OrthographicCamera cam = new OrthographicCamera(screen().actualWidth(), screen().actualHeight());
		cam.setToOrtho(false, screen().virtualWidth(), screen().virtualHeight());
